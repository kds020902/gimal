...
// 앱의 시작점 파일. "메인 앱"과 "오버레이"는 서로 다른 엔진에서 도는 별개의 시작점이라
// 두 개의 진입 함수(main / overlayMain)를 여기 모아 둠.

// ── 목차 ─────────────────────────────────
//  · 전역 상태     : 다크모드 notifier · 북마크/메모 캐시
//  · main()        : 메인 앱 시작점 (저장값 로드 → runApp)
//  · overlayMain() : 오버레이 시작점 (별도 엔진 · 트리쉐이킹 보존)
//  · MyApp         : 밝은/어두운 테마 정의
// ────────────────────────────────────────────
